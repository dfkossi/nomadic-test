...
import { switchMap, filter, first, tap, map, mapTo, switchMapTo, shareReplay, takeUntil, distinctUntilKeyChanged, publishReplay, refCount, pluck, concatMap } from 'rxjs/operators';
...
var OperationEmitter = /** @class */ (function () {
    ...
    OperationEmitter.prototype.prepareOperation = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var counter, counters, requiresReveal, ops, head, blockHeaderPromise, blockMetaPromise, publicKeyHash, counterPromise, managerPromise, i, counter_1, _b, header, metadata, headCounter, manager, haveManager, reveal, _c, constructOps, branch, contents, protocol;
            var _this = this;
...
var RPCEstimateProvider = /** @class */ (function (_super) {
    ...
    RPCEstimateProvider.prototype.createEstimate = function (params, kind) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, opbytes, _b, branch, contents, operation, _c, opResponse, errors, operationResults, totalGas, totalStorage;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, new Estimate(totalGas || 0, Number(totalStorage || 0), opbytes.length / 2)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        op = _b.sent();
                        return [2 /*return*/, this.createEstimate({ operation: op, source: pkh }, 'origination')];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        op = _b.sent();
                        return [2 /*return*/, this.createEstimate({ operation: op, source: pkh }, 'transaction')];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        op = _b.sent();
                        return [2 /*return*/, this.createEstimate({ operation: op, source: sourceOrDefault }, 'delegation')];
                }
            });
        });
    };
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 4:
                        ...
                        _e = { operation: op };
                        return [4 /*yield*/, this.signer.publicKeyHash()];
                    case 5: return [2 /*return*/, _d.apply(this, [(_e.source = _f.sent(), _e), 'delegation'])];
                }
            });
        });
    };
...
export { BigMapAbstraction, CompositeForger, DEFAULT_FEE, DEFAULT_GAS_LIMIT, DEFAULT_STORAGE_LIMIT, InvalidDelegationSource, InvalidParameterError, MANAGER_LAMBDA, Protocols, RpcForger, Tezos, TezosOperationError, TezosPreapplyFailureError, TezosToolkit, protocols };
